...
class BlenderDataModule(pl.LightningDataModule):
    ...
    def __init__(self, args, config,
        ...
        self.full_dataset = BlenderDataset(args.use_masks, crop_margin, args.resize_modality)
    ...
    def setup(self, stage=None):
        ...
        #     self.full_dataset, [self.train_split, 1-self.train_split]
        # ))
        print(len(self.training_dataset), len(self.validation_dataset))
