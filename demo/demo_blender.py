...
parser.add_argument('--scene_id', type=str, default='0000000',
  help='Scene ID in the dataset')
...
scene_dir =  f"/home/pita/HDD/sdb/datasets/main_pita/scene_{args.scene_id}"
img0_path = scene_dir + "/colors/0.png"
img1_path = scene_dir + "/colors/1.png"
weights_path = f"../weights/{args.weights}.ckpt"
